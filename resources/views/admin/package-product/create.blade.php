<x-admin-app-layout :title="__('Create Package Product')">

    <div class="pb-3 flex justify-between">
        <div class="text-3xl">{{ __('Create Package Product') }}</div>
        <div>
    ...
    <form action="{{ route('admin.package-product.store') }}" method="POST" enctype="multipart/form-data" >
        @csrf
