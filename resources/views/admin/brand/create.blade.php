<x-admin-app-layout :title="__('Create Brand')">

    <div class="pb-3 flex justify-between">
        <div class="text-3xl">{{ __('Create Brand') }}</div>
        <div>
    ...
    <form action="{{ route('admin.brand.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="bg-white p-4">
            ...
            <div class=" w-full">
                ...
                <x-labeled-input name="brand_name" required class="w-full p-1 md:w-1/2 lg:w-1/3" />
