...
/* harmony export */   anchor: () => (/* binding */ src_default),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _alpinejs_anchor__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @alpinejs/anchor */ "./node_modules/@alpinejs/anchor/dist/module.esm.js");
/* harmony import */ var alpinejs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! alpinejs */ "./node_modules/alpinejs/dist/module.esm.js");
__webpack_require__(/*! ./bootstrap */ "./resources/js/bootstrap.js");


alpinejs__WEBPACK_IMPORTED_MODULE_1__["default"].plugin(_alpinejs_anchor__WEBPACK_IMPORTED_MODULE_0__["default"]);
window.Alpine = alpinejs__WEBPACK_IMPORTED_MODULE_1__["default"];
alpinejs__WEBPACK_IMPORTED_MODULE_1__["default"].start();
document.addEventListener('DOMContentLoaded', function () {
  // Find all elements with the class 'only-number'
  var onlyNumberContainers = document.querySelectorAll('.only-number');

  // Add a listener to each container
  onlyNumberContainers.forEach(function (container) {
  ...
  document.addEventListener('submit', function (event) {
    if (!event.defaultPrevented && event.target.tagName.toLowerCase() === 'form') {
      event.target.querySelectorAll('button:not([type="button"])').forEach(function (button) {
        return button.disabled = true;
      });
      event.target.querySelectorAll('input[type="submit"]').forEach(function (button) {
        return button.disabled = true;
      });
    }
  });
