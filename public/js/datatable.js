...
/***/ "./resources/js/datatable-date-sort.js":
/*!*********************************************!*\
  !*** ./resources/js/datatable-date-sort.js ***!
  \*********************************************/
/***/ (() => {
...
{}
  ...
  DataTable.ext.renderer.pageButton.tailwindcss = function (settings, host, idx, buttons, page, pages) {
    ...
    var btnDisplay,
      btnClass,
      counter = 0;
    var _attach = function attach(container, buttons) {
      var i, ien, node, button;
    ...
    _attach($(host).empty().html('<ul class="pagination"/>').children('ul'), buttons);
    if (activeEl !== undefined) {
      $(host).find('[data-dt-idx=' + activeEl + ']').trigger('focus');
    }
  };
